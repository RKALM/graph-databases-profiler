    ...
    static boolean create(){
        if(Dataholder.databases_allowed){
            if(Dataholder.orientdb_script_test){
                ...
                OrientDbDB.createANode(Dataholder.customSeed + "" + Dataholder.dateSeed + "" + Dataholder.round
    ...
    static boolean update(){
        if(Dataholder.databases_allowed){
            if(Dataholder.orientdb_script_test){
                ...
                OrientDbDB.updateANode(Dataholder.customSeed + "" + Dataholder.dateSeed + ""
                        + Dataholder.round + "" + Dataholder.indicatorN + "" + Dataholder.countUpdate);
                return true;
            } else {
                //print a statement
    ...
    static boolean delete(){
        if(Dataholder.databases_allowed){
            if(Dataholder.orientdb_script_test){
                ...
                OrientDbDB.deleteANodeFake(Dataholder.customSeed + "" + Dataholder.dateSeed + "" + Dataholder.round
                        + "" + Dataholder.indicatorN + "" + Dataholder.countDeletion);
                return true;
            } else {
                //print a statement
